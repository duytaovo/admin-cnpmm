...
import { LegendType, SymbolType, AnimationTiming, D3Scale, ChartOffset, DataKey, TickItem, PresentationAttributesAdaptChildEvent, AnimationDuration } from 'recharts/types/util/types';
...
export declare class Scatter extends PureComponent<Props, State> {
    ...
    renderErrorBar(): React.ReactElement<import("recharts/types/cartesian/ErrorBar").Props, string | ((props: any) => React.ReactElement<any, any>) | (new (props: any) => React.Component<any, any, any>)>[];
