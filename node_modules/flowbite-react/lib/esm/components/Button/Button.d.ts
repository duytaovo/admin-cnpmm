...
import type { DeepPartial, FlowbiteBoolean, FlowbiteColors, FlowbiteGradientColors, FlowbiteGradientDuoToneColors, FlowbiteSizes } from 'flowbite-react';
import { type ButtonBaseProps } from 'flowbite-react/lib/esm/components/Button/ButtonBase';
import type { PositionInButtonGroup } from 'flowbite-react/lib/esm/components/Button/ButtonGroup';
...
export declare const Button: import("react").ForwardRefExoticComponent<Omit<Props, "ref"> & import("react").RefAttributes<HTMLButtonElement | HTMLAnchorElement>> & {
    Group: import("react").FC<import("flowbite-react/lib/esm/components/Button/ButtonGroup").ButtonGroupProps>;
};
export {};
