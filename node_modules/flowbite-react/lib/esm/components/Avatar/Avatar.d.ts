...
import type { DeepPartial, FlowbiteBoolean, FlowbiteColors, FlowbitePositions, FlowbiteSizes } from 'flowbite-react';
import type { FlowbiteAvatarGroupTheme } from 'flowbite-react/lib/esm/components/Avatar/AvatarGroup';
import type { FlowbiteAvatarGroupCounterTheme } from 'flowbite-react/lib/esm/components/Avatar/AvatarGroupCounter';
...
export declare const Avatar: FC<AvatarProps> & {
    Group: FC<import("flowbite-react/lib/esm/components/Avatar/AvatarGroup").AvatarGroupProps>;
    Counter: FC<import("flowbite-react/lib/esm/components/Avatar/AvatarGroupCounter").AvatarGroupCounterProps>;
};
