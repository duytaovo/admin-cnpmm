...
import type { ButtonProps, DeepPartial } from 'flowbite-react';
import type { FloatingProps, FlowbiteFloatingTheme } from 'flowbite-react/lib/esm/components/Floating';
import type { FlowbiteDropdownDividerTheme } from 'flowbite-react/lib/esm/components/Dropdown/DropdownDivider';
import type { FlowbiteDropdownHeaderTheme } from 'flowbite-react/lib/esm/components/Dropdown/DropdownHeader';
import type { FlowbiteDropdownItemTheme } from 'flowbite-react/lib/esm/components/Dropdown/DropdownItem';
...
export declare const Dropdown: FC<DropdownProps> & {
    Item: FC<import("flowbite-react/lib/esm/components/Dropdown/DropdownItem").DropdownItemProps>;
    Header: FC<{
        children?: ReactNode;
