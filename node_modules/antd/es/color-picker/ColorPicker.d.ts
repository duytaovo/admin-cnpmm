...
import type { ColorFormat, ColorValueType, PresetsItem, TriggerPlacement, TriggerType } from 'antd/es/color-picker/interface';
export type ColorPickerProps = Omit<RcColorPickerProps, 'onChange' | 'value' | 'defaultValue' | 'panelRender' | 'onChangeComplete'> & {
